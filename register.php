    ...
    <div class="row" style="margin-top: 4vh;" >
        <div class="container">
            ...
            border-radius: 10px; background-color: rgba(0, 0, 0, 0.9); backdrop-filter: blur(12px); ">
                ...
                <img class="responsive-image" src="img/lo.png" style=" height:8vh; filter:contrast(); width: 100%; margin-top: 0px; object-fit:contain;  ">

                    <form action="partial/company_signup.php" method="post" enctype='multipart/form-data'>
                        <ul class="stepper horizontal" style="height: 70vh;">
                            <li class="step active" >
                                <div class="step-title waves-effect" style="border-radius: 30px;">
                                    <p style="color: #f53838;font-weight: 500;">Owner Details</p>
                                </div>
                                <div class="step-content">
                                    <div class="row" style="margin-top:2.5em;">
                                        ...
                                        <div class="col s12 m6 l6">
                                            <div class="input-field col s12 m12 l12">
                                                ...
                                                placeholder="Username" required name="username" type="text" class="validate">
                                            </div>
                                            <div class="input-field col s12 m12 l12">
                                                <input style="color: #e87272; border: none; text-align: center;border: 1px solid #f53838; border-radius: 20px;" 
                                                placeholder="Email" required name="email" type="email" class="validate">
                                            </div>
                                            <div class="input-field col s12 m12 l12">
                                                <input style="color: #e87272; border: none; text-align: center;border: 1px solid #f53838; border-radius: 20px;"
                                                 placeholder="Password" required name="pass" type="password" class="validate">
                                            </div>
                                    ...
                                    <div class="step-actions">
                                        ...
                                        <a href="index.php" class="waves-effect waves-red btn  left " style="text-transform: capitalize !important; border-radius: 5px; background-color:transparent;  color: #f53838; ">Back</a>
                            ...
                            <li class="step">
                                <div class="step-title waves-effect" style="border-radius: 30px;">
                                    <p style="color: #f53838; font-weight: 500;">Company Deatils</p>
                                </div>
                                <div class="step-content">
                                    <div class="row" style="margin-top:0em;">
                                        ...
                                        <div class="col s12 m6 l6">
                                            <div class="input-field col s12 m12 l12">
                                                <input style="color: #e87272; border: 1px solid #f53838; text-align: center; border-radius: 20px;"
                                                 placeholder=" Company Name" required name="c_name" type="text" class="validate">
                                            </div>
                                            <div class="input-field col s12 m12 l12">
                                                <input style="color: #e87272; border: 1px solid #f53838; text-align: center; border-radius: 20px;"
                                                 placeholder="No. Of Tables" required name="num_tables" type="number" min="1" class="validate">
                                            </div>

                                            <div class="input-field col s12 m12 l12">
                                                <textarea style="color: #e87272; border: none; text-align: center;border: 1px solid #f53838; border-radius: 20px;"
                                                 placeholder="About Co."  name="c_des"  class="validate materialize-textarea"></textarea>
                                            </div>

                                            
                                            <div class="file-field input-field col s12 m12 l12">
                                                <div class="btn-small waves-effect waves-light" style="background-color: #f53838; border-radius: 20px;">
                                                    <span>Logo</span>
                                                    <input  type="file" name="c_logo">
                                                </div>
                                                <div class="file-path-wrapper">
                                                    <input placeholder="" disabled style="color: #e87272; border: none; border-bottom: 1px solid #f53838; border-radius: 0px;"  class="file-path " type="text">
                                                </div>
                                            </div>
