...
" id="mobile-demo">
        ...
        <div class="row side_sec">
            ...
            <div class="col s12 m9 l9 right" style=" margin-left: 0px;">
                        ...
                        <a href="#employees" style="color: #a3a3a3;">
                            <div class="card z-depth-1 cards1" style="border-radius: 8px;">
                                <div class="card-content white-text">
                                    ...
                                    <p style="color: #a3a3a3;margin-top: 1em;">Commnicate<a class="modal-trigger " href="#send_messages_form"> <i style=" color: gray;" class="right material-icons  ">send</i></a></p>
                ...
                <div id="send_messages_form" class="modal md" style="border-radius: 10px;">
                    <div class="modal-content">
                        <form action="messages.php" method="post">
                            <input type="hidden" name="admin_id" value="<?php echo $company; ?>">
                            <div class="row">
                                ...
                                <tbody" id="send_messages">
                                    ...
                                    ?>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            if ($m_from == $chef_id || $m_to == $chef_id) {

                                                
                                                $sql1 = "SELECT * FROM $t_name2 WHERE id ='$chef_id' ";
                                                $resultch1 = 0;
