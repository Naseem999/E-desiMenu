                ...
                <div class="row main_sec">
                    ...
                    <div id="add_chef" class="modal md" style="border-radius: 10px;">
                        <div class="modal-content">
                            <form action="crud_chef.php" method="post">
                                <div class="row">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="crud_chef.php?del_id=<?php echo $row['id']; ?>" style="  text-align: center; margin-left: 1.6em; height: 100%; background-color:transparent;   box-shadow: none; ">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="crud_employee.php?del_id=<?php echo $row['id']; ?>" style="  text-align: center; margin-left: 1.6em; height: 100%; background-color:transparent;   box-shadow: none; ">
                                                            <i style=" color: gray;" class=" material-icons  ">delete</i>
                                                        </a>
                                                    </td>
