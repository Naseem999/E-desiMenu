...
<body>
    <div class="row" style="margin-top: 10vh; ">
        ...
        <div class="col s12 m4 l4 center-align ">
            ...
            height:35em">
                <img class="responsive-image" src="img/lo.png" style=" height:10vh; filter:contrast(); width: 100%; margin-top: 0px; object-fit:contain;  ">
                <br>
                <div class="card-content white-text">
                    <form method="post" action="partial/co_login.php">
                        <br><br>
                      ...
                      width: 80%; text-align: center;color: white ; color:#e87272; border-bottom: 1px solid #e87272;  background-color: transparent;"></p>
                        <br>
                        <p style="text-align: center;"> <button name="c_login_submit" type="submit" style=" border: 0.2px solid #1c1c1c; background-color:transparent;  text-transform: capitalize; width: 70%; color: #f53838; font-weight: 600;  margin-top: 1.5em; border-radius: 50px;  " class=" waves-effect waves-red btn-large z-depth-3 ">Log in</button>
                        </p>
                        <p style="text-align: center; margin-top: 4em;"> <a href="index.php" style="  color:gray; ">Not Signed Up?</a>
                        </p>
                        <br>
                    </form>
                </div>
